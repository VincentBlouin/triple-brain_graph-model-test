...
public class ModelTestScenarios {
    ...
    public SuggestionPojo nameSuggestionFromPersonIdentification() {
    ...
    public SuggestionPojo nameSuggestionFromSymbolIdentification() {
    ...
    public SuggestionPojo startDateSuggestionFromEventIdentification() {
        return SuggestionPojo.fromSameAsAndDomainUriLabelAndOrigin(
